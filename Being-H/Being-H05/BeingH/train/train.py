...
class ModelArguments:
    ...
    action_loss_gripper_weight: float = field(
        default=1.0,
        metadata={"help": "Multiplier for Cobot gripper-like unified action dims 56 and 63."}
    )
    action_loss_late_chunk_start: int = field(
        default=-1,
        metadata={"help": "First action timestep that receives late-chunk loss weighting; -1 disables."}
    )
