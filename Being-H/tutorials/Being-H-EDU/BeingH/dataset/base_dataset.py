...
class PackedDataset(torch.utils.data.IterableDataset):
    ...
    def build_datasets(self, datasets_metainfo):
        ...
        for grouped_dataset_name, dataset_args in datasets_metainfo.items():
            ...
            dataset_path_overrides = dataset_args.pop('dataset_path_overrides', {})
            ...
            for item in dataset_names:
                ...
                dataset_path = dataset_path_overrides.get(item, meta_info['dataset_path'])
                dataset_args['dataset_path_list'].append(dataset_path)
