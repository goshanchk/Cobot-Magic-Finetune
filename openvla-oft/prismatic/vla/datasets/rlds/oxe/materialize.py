...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [
        ...
        ActionEncoding.COBOT_MAGIC_ABS_STATE,
    ]:
        raise ValueError(
            f"Cannot load `{dataset_name}`; only EEF_POS, EEF_R6, JOINT_POS_BIMANUAL, "
            "and COBOT_MAGIC_ABS_STATE actions supported!"
        )
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.COBOT_MAGIC_ABS_STATE:
